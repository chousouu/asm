...
scpu: stack.cpp cpu.cpp main.cpp
	$(CC) stack.cpp cpu.cpp main.cpp -o cpu $(CFLAGS) $(SANITIZERS)

sasm: asm.cpp 
	$(CC) asm.cpp -o asm $(CFLAGS) $(SANITIZERS)

asm: asm.cpp 
	   	   $(CC) asm.cpp -o asm $(CFLAGS)
		   
cpu: stack.cpp cpu.cpp main.cpp
	   	   $(CC) stack.cpp cpu.cpp main.cpp -o cpu $(CFLAGS)
